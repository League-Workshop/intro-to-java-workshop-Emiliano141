...
public class MadlibsOfTheAmazon {
	...
	public static void main(String[] args) {
	  ...
	  JOptionPane.showMessageDialog(null, "If you find yourself having to cross a piranha-infested river, here's how to do it..");
		...
		String adjective = JOptionPane.showInputDialog(null, "Enter a adjective");
		...
		String adLib = "Piranhas are more "+adjective+" during the day, so cross the river at\n" +
		...
		JOptionPane.showMessageDialog(null, adLib);
